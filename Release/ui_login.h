...
"}"));
        ...
        btnLogin->setGeometry(QRect(470, 590, 230, 61));
...
""));
        ...
        cp->setGeometry(QRect(641, 660, 210, 40));
        cp->setMinimumSize(QSize(210, 40));
        cp->setMaximumSize(QSize(210, 40));
        cp->setAlignment(Qt::AlignCenter);
        cp->setWordWrap(false);
        cp->setOpenExternalLinks(false);
        btnInput = new QPushButton(Login);
        btnInput->setObjectName(QString::fromUtf8("btnInput"));
        btnInput->setGeometry(QRect(150, 590, 230, 61));
        ...
        QWidget::setTabOrder(btnInput, btnLogin);
    ...
    void retranslateUi(QWidget *Login)
    {
        ...
        IdentityBox->setItemText(2, QApplication::translate("Login", "\345\255\246\351\231\242\347\256\241\347\220\206\345\221\230", nullptr));

        cp->setText(QApplication::translate("Login", "\345\207\272\345\223\201:\347\275\221\347\273\234\345\267\245\347\250\213\347\263\273\345\205\232\346\224\257\351\203\250\n"
"\346\230\216\347\273\206: \345\272\236\345\230\211\347\216\256", nullptr));
        btnInput->setText(QApplication::translate("Login", "\345\275\225\345\205\245\350\264\246\345\217\267", nullptr));
    } // retranslateUi
